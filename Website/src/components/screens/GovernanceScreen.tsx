          ...
          <DataTable<Policy>
            ...
            actionBar={
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-accent-g hover:bg-accent-g/85 text-white font-semibold text-xs rounded transition-colors uppercase font-mono tracking-wider"
              >
