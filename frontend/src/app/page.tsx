...
export default function EcoSphereWorkspace() {
  ...
  return (
    <div className="flex min-h-screen bg-bg-base relative font-sans antialiased text-text-primary">
      {/* Topographic map overlay at low opacity */}
      <div className="absolute inset-0 pointer-events-none opacity-5 topo-bg z-0" />
      ...
      <div className="flex-1 flex flex-col min-w-0 z-10 relative">
        ...
        {subTabs.length > 0 && (
          <div className="bg-bg-surface border-b border-border-hairline px-6 py-2 sticky top-16 z-20 flex gap-4 overflow-x-auto whitespace-nowrap scrollbar-none">
            {subTabs.map((sub) => {
              ...
              return (
                <button
                  ...
                  className={`
                    py-1 text-xs font-mono tracking-wider transition-all duration-150 relative cursor-pointer select-none uppercase
