  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/15 text-white/90 text-sm font-medium mb-6 backdrop-blur-sm">
        ...
        >
          Pavitrarpan
          <br />
          <span className="text-secondary-light">Foundation</span>
        </motion.h1>
        ...
        >
          Working towards environmental conservation, cleanliness, education,
          and social welfare for a sustainable future.
        </motion.p>
        ...
        >
          <Link
            href="/events"
            className="px-8 py-3 rounded-lg bg-accent text-text font-semibold hover:bg-accent-dark transition-colors shadow-lg hover:shadow-xl"
          >
            Explore Events
          </Link>
          <Link
            href="/contact"
            className="px-8 py-3 rounded-lg bg-white/15 text-white font-semibold hover:bg-white/25 backdrop-blur-sm transition-colors"
          >
            Get Involved
          </Link>
        </motion.div>
